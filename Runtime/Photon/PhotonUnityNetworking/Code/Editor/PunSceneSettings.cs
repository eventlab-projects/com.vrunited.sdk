    ...
    public class PunSceneSettings : ScriptableObject
    {
        ...
        public static string PunSceneSettingsCsPath
        {
            get
            {
                ...
                {
                    AssetDatabase.CreateFolder("Assets", "Photon");
                }
                if (!AssetDatabase.IsValidFolder("Assets/Photon/Editor"))
                {
                    AssetDatabase.CreateFolder("Assets/Photon", "Editor");
                }

                return "Assets/Photon/Editor/" + SceneSettingsFileName;
            }
        }
